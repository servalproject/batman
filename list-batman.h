 ...
 */
static inline void list_add( struct list_head *new, struct list_head_first *head ) {
 ...
 */
static inline void list_add_tail( struct list_head *new, struct list_head_first *head ) {
...
static inline void list_add_before( struct list_head *prev_node, struct list_head *next_node, struct list_head *new_node ) {
 ...
 */
static inline void list_del( struct list_head *prev_entry, struct list_head *entry, struct list_head_first *head ) {
 ...
 */
static inline int list_empty( struct list_head_first *head ) {
